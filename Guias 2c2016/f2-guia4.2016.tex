...
\begin{center}
\textsc{\large{}Guía 4: Oscilaciones en sistemas continuos}
\par\end{center}{\large \par}
\begin{enumerate}
...
y diámetro $d_{4}=0,1\unit{\,cm}$. Calcular las tensiones a las que
deben estar sometidas con respecto a la primera.
...
\item Usando las condiciones iniciales, halle $\Psi(x,t)$. Calcule $\rho(x,0)$.
\end{enumerate}
\begin{description}
